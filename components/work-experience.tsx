...
const WorkExperience = () => {
    ...
    return (
        <div className="font-poppins p-5">
            <div className="flex flex-col gap-9 items-center justify-center md:flex md:flex-col lg:flex-row lg:justify-start">
                {workExperienceArr.map((item) => (
                    ...
                    >
                        <div className="flex flex-col h-full justify-between items-center">
                            ...
                            <button onClick = {() => {router.push(item.link)}} // CANNOT NAVIGATE TO VIB
