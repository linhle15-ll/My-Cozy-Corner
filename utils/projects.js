...
import LinkGraphImg from "@/public/link_graph.png";
...
export const projectsArr = [
  {
    ...
    link: "https://github.com/linhle15-ll/link-graph",
    title: "Link Graph",
    role: "Production Engineering Fellow",
    description:
      "Multi-container staging environment for a digital research resource application",
    details: [
      "Technologies: Docker, Nginx, GitHub Actions, Linux, Python, Bash, Grafana, Prometheus, CI/CD",
      "Architected a multi-container staging environment for Link Graph using Docker and Nginx, isolating microservices, the database, and client layers for local and integration testing.",
      "Engineered automated GitHub Actions pipelines to run test suites, build container images, and automate staging deployments, reducing setup time by 80%.",
    ],
  },
  {
    key: 0,
